...
class DSAAnalyzer:
    ...
    def __init__(self, excel_path, image_base_dir, output_dir,
        ...
        self.stats = {
            ...
            'overlay_generated': 0,
            'contrast_adjusted': 0  # 新增：记录对比度调整的次数
        }
        ...
        # 对比度调整阈值
        self.min_contrast_threshold = 100  # 最小对比度阈值
    ...
    def adaptive_contrast_adjustment(self, image_frames):
        """
        基于第5帧的自适应对比度调整
        如果第5帧的最大最小值差异小于100，则将对比度拉伸到150

        Args:
            image_frames: 原始图像帧序列

        Returns:
            adjusted_frames: 对比度调整后的图像帧序列
    ...
    def process_sequence(self, image_frames, threshold_percent, frame_percent,
                         ...
                         enable_adaptive_contrast=True,  # 修改参数名
