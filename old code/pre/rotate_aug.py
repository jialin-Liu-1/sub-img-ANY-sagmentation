...
def process_images():
    # 输入路径
    dicom_dir = r"D:\med_data\multi\preprocess\min\1\dicom"  # DICOM医学图像目录
    mask_dir = r"D:\med_data\multi\preprocess\min\1\mask"  # TIF mask图像目录

    # 输出路径
    output_dicom_dir = r"D:\med_data\multi\preprocess\min\1\dicom_rot5"  # 旋转后的DICOM图像
    output_png_dir = r"D:\med_data\multi\preprocess\min\1\dicom_rot5\png"  # 旋转后的PNG医学图像
    output_mask_dir = r"D:\med_data\multi\preprocess\min\1\mask_rot5"  # 旋转后的TIF mask图像
