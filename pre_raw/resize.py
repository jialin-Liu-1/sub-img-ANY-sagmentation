...
def main():
    # 设置路径
    dicom_dir = "D:/med_data/multi/preprocess/MEAN/DICOM"  # 原始DICOM文件目录
    mask_dir = "D:/med_data/multi/preprocess/MEAN_mask"  # 原始掩码文件目录
    output_dicom_dir = "D:/med_data/multi/preprocess/MEAN/DSA_resized"  # 输出DICOM文件目录
    output_mask_dir = "D:/med_data/multi/preprocess/MEAN/mask_resized"  # 输出掩码文件目录
